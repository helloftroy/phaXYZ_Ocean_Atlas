...
# cluster/bin holds the static MMseqs2 binary installed by
# ./cluster/install_mmseqs2.sh (needed by \`pha-reference cluster95\`) --
# harmless to add even if that script hasn't been run yet.
